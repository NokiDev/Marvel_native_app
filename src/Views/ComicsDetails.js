	...
	render() {
		...
		return (
			<View style={{width : "100%", height : "100%"}}>
				...
				<ComicCard characters={characters}
						   creators={creators} events={events} issueNumber={comic.issueNumber}
						   series={series} stories={stories} text={comic.description}
						   thumbnailUri={`${comic.thumbnail.path}.${comic.thumbnail.extension}`} title={comic.title}/>
			</View>
		)
	}
}
